...
{
    /// <summary>
    /// Controls stationary turret enemy AI with aiming and attack behavior.
    /// </summary>
    /// <remarks>
    /// Requires EnemyController. Smoothly rotates pivot toward detected targets
    /// with configurable fire delay and aim sharpness.
    /// </remarks>
    [RequireComponent(typeof(EnemyController))]
    public class EnemyTurret : MonoBehaviour
    {
        /// <summary>AI behavior states for turret enemies.</summary>
        public enum AIState
        {
            Idle,
            Attack,

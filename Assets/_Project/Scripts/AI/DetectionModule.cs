...
{
    /// <summary>
    /// Handles enemy target detection via raycasts and manages detection state transitions.
    /// </summary>
    /// <remarks>
    /// Uses line-of-sight checks to detect hostile actors within range. Tracks last-seen time
    /// for detection timeout behavior. Triggers animator parameters for attack and damage reactions.
    /// </remarks>
